...
class MultiHeadAttention(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads, name="multi_head_attention", regularizer = None, initializer=None):
        ...
        self.query_dense = tf.keras.layers.Dense(units=d_model, activation='linear', kernel_regularizer=regularizer, kernel_initializer=initializer)
        self.key_dense = tf.keras.layers.Dense(units=d_model, activation='linear', kernel_regularizer=regularizer, kernel_initializer=initializer)
        self.value_dense = tf.keras.layers.Dense(units=d_model, activation='linear', kernel_regularizer=regularizer, kernel_initializer=initializer)
        self.output_dense = tf.keras.layers.Dense(units=d_model, activation='linear', kernel_regularizer=regularizer, kernel_initializer=initializer)
